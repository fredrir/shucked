...
use shucked_parser::{ShellDialect as ParseShellDialect, ShellProfile, ZshOptionState};
...
fn subscript_is_semantic_zero(subscript: &shucked_ast::Subscript, source: &str) -> bool {
    subscript
        .arithmetic_ast
        .as_ref()
...
mod tests {
    ...
    use shucked_parser::parser::ShellDialect;
    #[cfg(windows)]
    use std::fs;
...
",
    ...
    fn dedup_plugin_requests_preserves_first_request_order_when_replacing_duplicates() {
        ...
        alpha_implicit.span.start = shucked_ast::Position::at(
        ...
        beta_explicit.span.start = shucked_ast::Position::at(
