...
impl<'a, 'idx, 'observer> SemanticModelBuilder<'a, 'idx, 'observer> {
    pub(super) fn classify_special_simple_command(
        ...
        match name.as_str() {
            ...
            "zparseopts" if self.shell_profile.dialect == shucked_parser::ShellDialect::Zsh => {
            ...
            "zstyle" if self.shell_profile.dialect == shucked_parser::ShellDialect::Zsh => {
            ...
            "_describe" if self.shell_profile.dialect == shucked_parser::ShellDialect::Zsh => {
            ...
            "_arguments" if self.shell_profile.dialect == shucked_parser::ShellDialect::Zsh => {
            ...
            "compinit" if self.shell_profile.dialect == shucked_parser::ShellDialect::Zsh => {
                self.add_binding(
                    &Name::from("_comps"),
            ...
            "_wanted" if self.shell_profile.dialect == shucked_parser::ShellDialect::Zsh => {
            ...
            "integer" if self.shell_profile.dialect == shucked_parser::ShellDialect::Zsh => {
