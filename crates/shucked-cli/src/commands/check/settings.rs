...
pub(super) use shucked_linter::{CompiledPerFileShellList, PerFileShell};
...
impl EffectiveCheckSettings {
    ...
    fn new(
        ...
        rule_options: &shucked_linter::LinterRuleOptions,
...
impl EffectiveRuleOptions {
    fn new(rule_options: &shucked_linter::LinterRuleOptions) -> Self {
        Self {
...
fn s083_require_for_cache_value(value: shucked_linter::S083FunctionDocRequirement) -> u8 {
    match value {
        shucked_linter::S083FunctionDocRequirement::All => 0,
        shucked_linter::S083FunctionDocRequirement::Exported => 1,
        shucked_linter::S083FunctionDocRequirement::Long => 2,
        shucked_linter::S083FunctionDocRequirement::Parameterized => 3,
    }
}
...
fn linter_rule_options_for_lint_config(
    lint: &LintConfig,
) -> Result<shucked_linter::LinterRuleOptions> {
        ...
        .and_then(|s083| s083.require_for)
    {
        rule_options.s083.require_for = match value {
            shucked_config::S083RequireForConfig::All => {
                shucked_linter::S083FunctionDocRequirement::All
            }
            shucked_config::S083RequireForConfig::Exported => {
                shucked_linter::S083FunctionDocRequirement::Exported
            }
            shucked_config::S083RequireForConfig::Long => {
                shucked_linter::S083FunctionDocRequirement::Long
            }
            shucked_config::S083RequireForConfig::Parameterized => {
                shucked_linter::S083FunctionDocRequirement::Parameterized
            }
        };
    }
    if let Some(value) = lint
